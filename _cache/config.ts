...
export default {
  global: {
     ...
     */
    opg: {
      'profile:first_name': 'Julián',
      'profile:gender': 'male', // male, female
      'profile:last_name': 'Casaburi',
    },
  ...
  data: {
     ...
     * @type {string}
     */
    position: 'Software Developer - Studying @ Facultad de Informática - UNLP',
     ...
     */
    socialMedia: [
      { name: 'Github', icon: 'github', link: 'https://github.com/juliancasaburi' },
      { name: 'Gitlab', icon: 'gitlab', link: 'https://gitlab.com/juliancasaburi' },
      { name: 'Twitter', icon: 'twitter', link: 'https://twitter.com/JulianCasaburi' },
    ],
  },
